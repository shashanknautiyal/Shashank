...
Member_data_2.createOrReplaceTempView('finalmem')
...
nhm_dailler=spark.read.option("delimiter","|").csv("s3://cmh-process-data/master-tables/master_table_nhm_dialler/nhm_dialler.csv",header =True,inferSchema=True)

nhm_dailler=nhm_dailler.withColumn('business_date',lit(business_day))

## Applying filter for current month 
nhm_dailler_current_month= nhm_dailler.filter('Date >= date_add(last_day(business_date - interval 01 months),1) and Date<=(last_day(business_date))')

nhm_dailler_current_month.createOrReplaceTempView('new')

nhm_dailler_select_columns=spark.sql("Select right(ContactNo,10) as ContactNo,TerminationStatus from new")

## Applying Crosstab on ContactNo column and TerminationStatus column to get the count to contacted and Not_Contacted contacts 

nhm_dailler_mobile_data=nhm_dailler_select_columns.crosstab('ContactNo','TerminationStatus')
nhm_dailler_mobile_data=nhm_dailler_mobile_data.withColumnRenamed('Contacted','Contacted_m').withColumnRenamed('Not Contacted','Not_Contacted_m')
nhm_dailler_mobile_data.createOrReplaceTempView('ps')

## Applying Crosstab on ContactNo column and Contactedstatus column to get the count to contacted and Not_Contacted contacts 

nhm_dailler_tres1_data=nhm_dailler_select_columns.crosstab('ContactNo','TerminationStatus')
nhm_dailler_tres1_data=nhm_dailler_tres1_data.withColumnRenamed('Contacted','Contacted_t1').withColumnRenamed('Not Contacted','Not_Contacted_t1')
nhm_dailler_tres1_data.createOrReplaceTempView('ps1')

## Applying Crosstab on ContactNo column and Contactedstatus column to get the count to contacted and Not_Contacted contacts 

nhm_dailler_tres2_data=nhm_dailler_select_columns.crosstab('ContactNo','TerminationStatus')
nhm_dailler_tres2_data=nhm_dailler_tres2_data.withColumnRenamed('Contacted','Contacted_t2').withColumnRenamed('Not Contacted','Not_Contacted_t2')
nhm_dailler_tres2_data.createOrReplaceTempView('ps2')

# Mapping Mobile_No column from Member_data_2 with Contacted_m and Not_Contacted_m from nhm_dailler_mobile_data.
mobile_no_mapped=spark.sql("select fm.*, ps.Contacted_m, ps.Not_Contacted_m from fm left join ps on fm.Mobile_No=ps.ContactNo_TerminationStatus")
mobile_no_mapped.createOrReplaceTempView('temp')

# Mapping tres1 column from Member_data_2 with Contacted_t1 and Not_Contacted_t1 from nhm_dailler_tres1_data.
tres1_no_mapped=spark.sql("select temp.*,ps1.Contacted_t1,ps1.Not_Contacted_t1 from temp left join ps1 on temp.tResPhone1=ps1.ContactNo_TerminationStatus")
tres1_no_mapped.createOrReplaceTempView('temp2')

# Mapping tres2 column from Member_data_2 with Contacted_t1 and Not_Contacted_t1 from nhm_dailler_tres2_data.
tres2_no_mapped=spark.sql("select temp2.*,ps2.Contacted_t2,ps2.Not_Contacted_t2 from temp2 left join ps2 on temp2.tResPhone2=ps2.ContactNo_TerminationStatus")
...
Final_Member_Data=Member_data_3.withColumn('total_attempted',(Member_data_3.Contacted+Member_data_3.Not_Contacted))
...
Final_member_data_dubai=spark.sql("select t.*,case when total_attempted >0 then 'yes' else 'no' end as attempted_dialer,case when contacted>0 then 'yes' else 'no' end as contacted_dialer,case when PDI_Amount>0 then 1 else 0 end as realized from ttr1 t")
Final_member_data_dubai.createOrReplaceTempView("mem1")

# Applying the Business Logic on the Final_Member_Data to generate the nhm_contact_metrics_dashboard metrics

nhm_contact_metrics_dubai =spark.sql("select m.Category,sum(case when m.Rating='hot' then 1 else 0 end) as base_hot,sum(case when m.Rating='warm' then 1 else 0 end) as base_warm,sum(case when m.Rating='cold' then 1 else 0 end) as base_cold,sum(case when m.Rating is null then 1 else 0 end) as base_unknown,count(*) as base_total,sum(case when m.Rating='hot' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_hot,sum(case when m.Rating='warm' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_warm,sum(case when m.Rating='cold' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_cold,sum(case when m.Rating is null and m.attempted_dialer='yes' then 1 else 0 end) as attempted_unknown,sum(case when m.attempted_dialer='yes' then 1 else 0 end) as attempted_total,sum(case when m.Rating='hot' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_hot,sum(case when m.Rating='warm' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_warm,sum(case when m.Rating='cold' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_cold,sum(case when m.Rating is null and m.contacted_dialer='yes' then 1 else 0 end) as contacted_unknown,sum(case when m.contacted_dialer='yes' then 1 else 0 end) as contacted_total,sum(case when m.Rating='hot' and m.realized=1 then 1 else 0 end) as realized_hot,sum(case when m.Rating='warm' and m.realized=1 then 1 else 0 end) as realized_warm,sum(case when m.Rating='cold' and m.realized=1 then 1 else 0 end) as realized_cold,sum(case when m.Rating is null and m.realized=1 then 1 else 0 end) as realized_unknown,sum(case when m.realized=1 then 1 else 0 end) as realized_total,sum(case when m.Rating='hot' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_hot,sum(case when m.Rating='warm' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_warm,sum(case when m.Rating='cold' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_cold,sum(case when m.Rating is null and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_unknown,sum(case when m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_total,sum(case when m.Rating='hot' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_hot,sum(case when m.Rating='warm' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_warm,sum(case when m.Rating='cold' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_cold,sum(case when m.Rating is null and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_unknown,sum(case when m.realized=1 then PDI_Amount else 0 end) as Amt_realized_total from mem1 m where m.Category is not null group by m.Category")
nhm_contact_metrics_dubai.createOrReplaceTempView("tests1")

# Applying the Business Logic on the Final_Member_Data to generate the nhm_contact_metrics_dashboard metrics
nhm_contact_metrics_dubai_1=spark.sql("select t.*,((attempted_hot/base_hot)*100) as perc_attempted_hot,((attempted_warm/base_warm)*100) as perc_attempted_warm,((attempted_cold/base_cold)*100) as perc_attempted_cold,((attempted_total/base_total)*100) as perc_total,((contacted_hot/base_hot)*100) as perc_con_allocated_hot,((contacted_warm/base_warm)*100) as perc_con_allocated_warm,((contacted_cold/base_cold)*100) as perc_con_allocated_cold,((contacted_total/base_total)*100) as perc_con_allocated_total,((contacted_hot/attempted_hot)*100) as perc_con_outofattm_hot,((contacted_warm/attempted_warm)*100) as perc_con_outofattm_warm,((contacted_cold/attempted_cold)*100) as perc_con_outofattm_cold,((contacted_total/attempted_total)*100) as perc_con_outofattm_total,((no_of_calls_hot/attempted_hot)) as churn_hot,((no_of_calls_warm/attempted_warm)) as churn_warm,((no_of_calls_cold/attempted_cold)) as churn_cold,((no_of_calls_unknown/attempted_total)) as churn_unknown,((no_of_calls_total/attempted_total)) as churn_total,no_of_calls_hot/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_hot,no_of_calls_warm/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_warm,no_of_calls_cold/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_cold,no_of_calls_total/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_total,((realized_hot/base_hot)*100) as perc_conversion_allo_hot,((realized_warm/base_warm)*100) as perc_conversion_allo_warm,((realized_cold/base_cold)*100) as perc_conversion_allo_cold,((realized_total/base_total)*100) as perc_conversion_allo_total,((realized_hot/attempted_hot)*100) as perc_conversion_attem_hot,((realized_warm/attempted_warm)*100) as perc_conversion_attem_warm,((realized_cold/attempted_cold)*100) as perc_conversion_attem_cold,((realized_total/attempted_total)*100) as perc_conversion_attem_total from tests1 t")


nhm_contact_metrics_dubai_1=nhm_contact_metrics_dubai_1.withColumn('run_date',lit(current_date()))

nhm_contact_metrics_dubai_1=nhm_contact_metrics_dubai_1.withColumn('run_date',nhm_contact_metrics_dubai_1.run_date.cast('string'))

nhm_contact_metrics_dubai_1.createOrReplaceTempView('td7')

nhm_contact_metrics_dubai_old=spark.read.option("delimiter",",").csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/dubai_contact_metrics/NHM_dubai_base.csv",header =True,inferSchema=True)

# nhm_contact_metrics_dubai_old=nhm_contact_metrics_dubai_old.withColumn('run_date',to_date('run_date','dd-MM-yyyy'))

nhm_contact_metrics_dubai_old=nhm_contact_metrics_dubai_old.withColumn('run_date',to_date('run_date','yyyy-MM-dd'))

nhm_contact_metrics_dubai_old=nhm_contact_metrics_dubai_old.withColumn('run_date',nhm_contact_metrics_dubai_old.run_date.cast('string'))

nhm_contact_metrics_dubai_old.createOrReplaceTempView('td7o')

nhm_contact_metrics_dubai_final=spark.sql('select * from td7 union all select * from td7o')

nhm_contact_metrics_dubai_final.coalesce(1).write.csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/dubai_contact_metrics",mode="append",header="true")

## Creating Final Member data for Non-Dubai Locations by Filtering the data for ControlLocation <> "Dubai" 

Final_member_data_normal_base=spark.sql('select * from ttr where ControlLocation <> "Dubai"')

Final_member_data_normal_base.createOrReplaceTempView('ttr2')

Final_member_data_normal_base=spark.sql("select t.*,case when total_attempted >0 then 'yes' else 'no' end as attempted_dialer,case when contacted>0 then 'yes' else 'no' end as contacted_dialer,case when PDI_Amount>0 then 1 else 0 end as realized from ttr2 t")

Final_member_data_normal_base.createOrReplaceTempView("mem2")

nhm_contact_metrics_normal_base=spark.sql("select m.Category,sum(case when m.Rating='hot' then 1 else 0 end) as base_hot,sum(case when m.Rating='warm' then 1 else 0 end) as base_warm,sum(case when m.Rating='cold' then 1 else 0 end) as base_cold,sum(case when m.Rating is null then 1 else 0 end) as base_unknown,count(*) as base_total,sum(case when m.Rating='hot' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_hot,sum(case when m.Rating='warm' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_warm,sum(case when m.Rating='cold' and m.attempted_dialer='yes' then 1 else 0 end) as attempted_cold,sum(case when m.Rating is null and m.attempted_dialer='yes' then 1 else 0 end) as attempted_unknown,sum(case when m.attempted_dialer='yes' then 1 else 0 end) as attempted_total,sum(case when m.Rating='hot' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_hot,sum(case when m.Rating='warm' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_warm,sum(case when m.Rating='cold' and m.contacted_dialer='yes' then 1 else 0 end) as contacted_cold,sum(case when m.Rating is null and m.contacted_dialer='yes' then 1 else 0 end) as contacted_unknown,sum(case when m.contacted_dialer='yes' then 1 else 0 end) as contacted_total,sum(case when m.Rating='hot' and m.realized=1 then 1 else 0 end) as realized_hot,sum(case when m.Rating='warm' and m.realized=1 then 1 else 0 end) as realized_warm,sum(case when m.Rating='cold' and m.realized=1 then 1 else 0 end) as realized_cold,sum(case when m.Rating is null and m.realized=1 then 1 else 0 end) as realized_unknown,sum(case when m.realized=1 then 1 else 0 end) as realized_total,sum(case when m.Rating='hot' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_hot,sum(case when m.Rating='warm' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_warm,sum(case when m.Rating='cold' and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_cold,sum(case when m.Rating is null and m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_unknown,sum(case when m.attempted_dialer='yes' then total_attempted else 0 end) as no_of_calls_total,sum(case when m.Rating='hot' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_hot,sum(case when m.Rating='warm' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_warm,sum(case when m.Rating='cold' and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_cold,sum(case when m.Rating is null and m.realized=1 then PDI_Amount else 0 end) as Amt_realized_unknown,sum(case when m.realized=1 then PDI_Amount else 0 end) as Amt_realized_total from mem2 m where m.Category is not null group by m.Category")

nhm_contact_metrics_normal_base.createOrReplaceTempView("tests2")

nhm_contact_metrics_normal_base_1=spark.sql("select t.*,((attempted_hot/base_hot)*100) as perc_attempted_hot,((attempted_warm/base_warm)*100) as perc_attempted_warm,((attempted_cold/base_cold)*100) as perc_attempted_cold,((attempted_total/base_total)*100) as perc_total,((contacted_hot/base_hot)*100) as perc_con_allocated_hot,((contacted_warm/base_warm)*100) as perc_con_allocated_warm,((contacted_cold/base_cold)*100) as perc_con_allocated_cold,((contacted_total/base_total)*100) as perc_con_allocated_total,((contacted_hot/attempted_hot)*100) as perc_con_outofattm_hot,((contacted_warm/attempted_warm)*100) as perc_con_outofattm_warm,((contacted_cold/attempted_cold)*100) as perc_con_outofattm_cold,((contacted_total/attempted_total)*100) as perc_con_outofattm_total,((no_of_calls_hot/attempted_hot)) as churn_hot,((no_of_calls_warm/attempted_warm)) as churn_warm,((no_of_calls_cold/attempted_cold)) as churn_cold,((no_of_calls_unknown/attempted_total)) as churn_unknown,((no_of_calls_total/attempted_total)) as churn_total,no_of_calls_hot/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_hot,no_of_calls_warm/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_warm,no_of_calls_cold/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_cold,no_of_calls_total/(select sum(no_of_calls_total) from tests)*100 as perc_total_call_total,((realized_hot/base_hot)*100) as perc_conversion_allo_hot,((realized_warm/base_warm)*100) as perc_conversion_allo_warm,((realized_cold/base_cold)*100) as perc_conversion_allo_cold,((realized_total/base_total)*100) as perc_conversion_allo_total,((realized_hot/attempted_hot)*100) as perc_conversion_attem_hot,((realized_warm/attempted_warm)*100) as perc_conversion_attem_warm,((realized_cold/attempted_cold)*100) as perc_conversion_attem_cold,((realized_total/attempted_total)*100) as perc_conversion_attem_total from tests2 t")

nhm_contact_metrics_normal_base_1=nhm_contact_metrics_normal_base_1.withColumn('run_date',lit(current_date()))

nhm_contact_metrics_normal_base_1=nhm_contact_metrics_normal_base_1.withColumn('run_date',nhm_contact_metrics_normal_base_1.run_date.cast('string'))

nhm_contact_metrics_normal_base_1.createOrReplaceTempView('nb4')


nhm_contact_metrics_normal_base_old=spark.read.option("delimiter",",").csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/Normal_base_contact_metrics/NHM_normal_base.csv",header =True,inferSchema=True)

# nhm_contact_metrics_normal_base_old=nhm_contact_metrics_normal_base_old.withColumn('run_date',to_date('run_date','dd-MM-yyyy'))

nhm_contact_metrics_normal_base_old=nhm_contact_metrics_normal_base_old.withColumn('run_date',to_date('run_date','yyyy-MM-dd'))
nhm_contact_metrics_normal_base_old=nhm_contact_metrics_normal_base_old.withColumn('run_date',nhm_contact_metrics_normal_base_old.run_date.cast('string'))


nhm_contact_metrics_normal_base_old.createOrReplaceTempView('nb4o')

nhm_contact_metrics_normal_base_final=spark.sql('select * from nb4 union all select * from nb4o')

nhm_contact_metrics_normal_base_final.coalesce(1).write.csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/Normal_base_contact_metrics",mode="append",header="true")
...
master_table_summary_old= spark.read.option("delimiter",",").csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/Table_details/table_details.csv",header =True,inferSchema=True)

#master_table_summary_old=master_table_summary_old.withColumn('run_date',to_date('run_date','dd-MM-yyyy')).withColumn('last_modified',to_date('last_modified','dd-MM-yyyy'))
...
master_table_summary_final.coalesce(1).write.csv("s3://cmh-process-data/intermediate_files/NHM_Contact_Metrics/Table_details",mode="append",header="true")
