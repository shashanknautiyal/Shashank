...
#emi_dialler.coalesce(1).write.csv("s3://cmh-process-data/intermediate_files/Emi_Collection_Dashboard/Table_details",mode="append",header="true")
...
# change Take count of Contract_No 
...
con_pay_select=con_pay.select('reference_document','pdi_type','pdi_status','pdi_realization_date','installment_date','pdi_received_date','pdi_returned_date','dw_last_modified_date')
...
#table_3 = spark.sql('select "EMI_Target_Table" as Table_name, "2019-10-01" as last_modified, current_date() as run_date')
...
#table_7 = spark.sql('select "Agent_Role_Mapping_Table" as Table_name, "2019-10-01" as last_modified, current_date() as run_date')
...
#table_I.coalesce(1).write.csv("s3://cmh-process-data/intermediate_files/Emi_Collection_Dashboard/Table_details",mode="append",header="true")
...
#emi_table_old=emi_table_old.withColumn('run_date',to_date('run_date','dd-MM-yyyy')).withColumn('last_modified',to_date('last_modified','dd-MM-yyyy'))
