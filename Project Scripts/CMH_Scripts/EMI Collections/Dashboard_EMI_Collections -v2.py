...
od_base_inflow=od_base_inflow.dropDuplicates(['Contract_No'])
...
day_wise_summ=spark.sql("select New_Branch,day,count(AgentName) as Total_calls, count(distinct AgentName) as Total_agents from emtc group by New_Branch,day")
